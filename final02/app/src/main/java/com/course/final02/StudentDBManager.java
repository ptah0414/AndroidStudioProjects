...
public class StudentDBManager extends SQLiteOpenHelper {
    static final String STUDENT_DB = "Stduents.db";
    ...
    static final String CREATE_DB = " CREATE TABLE " +
            STUDENT_TABLE + " (_id INTEGER PRIMARY KEY AUTOINCREMENT, " + " student_id TEXT NOT NULL, name TEXT NOT NULL, phone_number TEXT);";
